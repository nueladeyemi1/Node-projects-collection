...
var showAlert = exports.showAlert = function showAlert(type, msg) {
  ...
  document.querySelector('body').innerAdjacentHTML('afterbegin', markup);
...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibnVlbGFkZXllbWkiLCJhIjoiY2xyd2U2cGpyMHRiNTJsbXJ4cjB3aWpkYSJ9.snQ_2XaXJvTYLi3IL-ztqw';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTop(map);
...
//# sourceMappingURL=/burdle.js.map